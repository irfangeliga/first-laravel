<header class="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
    ...
    <div class="flex items-center">
        <div>
            <button id="fullScreen" onclick="openFullscreen(this)"><i class="bi bi-arrows-fullscreen"></i></button>
            <button id="exitScreen" class="hidden" onclick="closeFullscreen(this)"><i
                    class="bi bi-fullscreen-exit"></i></button>
        </div>
        ...
        <x-form>
            ...
            <button type="submit"
                class="py-1 px-5 ms-5 rounded-lg font-light border text-black border-slate-900 hover:border-red-500  hover:text-white transition ease-in-out delay-100 hover:bg-red-500  hover:duration-500">
                Logout
            </button>
        </x-form>
    </div>
